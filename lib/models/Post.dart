...
class Post extends Model {
  ...
  const Post._internal({required this.id, title, isComplete, createdAt, updatedAt}): _title = title, _isComplete = isComplete, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Post({String? id, String? title, bool? isComplete}) {
  ...
  Post copyWith({String? id, String? title, bool? isComplete}) {
    return Post._internal(
      id: id ?? this.id,
